      ...
      <div className="pt-12 pb-20 sm:pt-16 lg:pt-24 lg:pb-28">
        <div ref={ref} style={style} className="container-custom">
          <div className="mx-auto max-w-[760px]">
            ...
            <div className="mt-12 border-t border-white/30 pt-10 text-[15.5px] font-light leading-relaxed text-white/78 [&_h2]:mb-3 [&_h2]:text-[20px] [&_h2]:font-medium [&_h2]:tracking-[-0.02em] [&_h2]:text-white [&_section]:mb-10 [&_p]:mb-4 [&_ul]:mb-4 [&_ul]:list-disc [&_ul]:pl-6 [&_li]:mb-1.5 [&_a]:text-white [&_a]:underline [&_a]:underline-offset-4 [&_strong]:font-medium [&_strong]:text-white">
              {children}
            </div>
          </div>
        </div>
